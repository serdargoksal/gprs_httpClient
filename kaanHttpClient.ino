...
const char server[] = "www.kaangoksal.com";
const int  port     = 5001;
// Path to download (this is the bit after the hostname in the URL)
const char resource[] = "/test_post";
...
void setup() {
     PostData="sample={\"fittingId\":1,";  
     for(int i=0;i<6;i++)
  {
    PostData=PostData+"\"channel-";
    PostData=String(PostData+i);
    PostData=PostData+"\":";
    PostData=String(PostData + String(random(100)));
    if(i!=5)
    PostData=PostData+",";
  ...
  PostData=PostData+"}"; 
  PostData="{\"data\":1}\r\n";
     content+= "/test_post HTTP/1.1\r\n";
     content+= "Content-Type: application/json\r\n";
     content+= "Host: kaangoksal.com:5001\r\n";
     content+= "content-length: ";
     content+= String(PostData.length()) +"\r\n";
     content+= "\r\n";
     content+= PostData + "\r\n";
